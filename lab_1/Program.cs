    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                try
                {
                    n = Convert.ToInt32(Console.ReadLine()); //преобразование числа
                    f_n = true;
                }
                catch
                {
            ...
            do
            {
                ...
                try
                {
                    m = Convert.ToInt32(Console.ReadLine()); //преобразование числа
                    f_m = true;
                }
                catch
                {
            ...
            do
            {
                ...
                try
                {
                    x = Convert.ToDouble(Console.ReadLine()); //преобразование числа
                    f_x = true;
                }
                catch
                {
            ...
            float num_f = (float)Math.Pow(a_f-b_f, 4) - ((float)Math.Pow(a_f, 4) - 4*b_f*(float)Math.Pow(a_f, 3));
            float den_f = 6*(float)Math.Pow(a_f, 2) * (float)Math.Pow(b_f, 2) - 4*a_f*(float)Math.Pow(b_f, 3) + (float)Math.Pow(b_f, 4);
            float result_f = num_f / den_f;

            double a_d = 1000, b_d = 0.0001;
            double num_d = Math.Pow(a_d - b_d, 4) - (Math.Pow(a_d, 4) - 4 * b_d * Math.Pow(a_d, 3));
            double den_d = 6*Math.Pow(a_d, 2) * Math.Pow(b_d, 2) - 4*a_d*Math.Pow(b_d, 3) + Math.Pow(b_d, 4);
